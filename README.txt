This version of SMBX2 is actually a bit different compared to the mainline version. This version does the following:
...
(The only problem this has is that it crashes with recording GIFs, which will be fixes in the future, but other than that, everything works as intended)
