...
local function init(v)
	...
	data.light = Darkness.light{x=0, y=0, radius = s.radius or 64, brightness = s.brightness, color = s.color, flicker = s.flicker, type = Darkness.lighttype.SPOT, dir = vector.down2:rotate(s.angle), spotangle = s.spotangle, spotpower = s.spotpower}
